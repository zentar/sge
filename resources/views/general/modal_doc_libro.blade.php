                  ...
                  <div class="col-md-12">
                     ...
                     <div class="form-group col-md-12">
                        <label>Seleccione el tipo de documento*:</label> 
                           ...
                           <select id='tipo_doc' style='width: 100%' class='form-control select2' name='tipo_doc[]'>
                              <option value='null'>Seleccionar Tipo Documento </option>
                              @foreach($tipos_doc_libro as $tipo)
                     ...
                     <div class="form-group col-md-12">                     
                        ...
                        {!!Form::text('observaciones',null,['class'=>'form-control col-md-12',
